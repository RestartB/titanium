...
class StripTracking(commands.Cog):
    ...
    @app_commands.command(name = "strip-tracking", description = "Remove known trackers from a URL.")
    ...
    async def strip_tracking(self, interaction: discord.Interaction, url: str, ephemeral: bool = False):
        ...
        embed = discord.Embed(title = "URL: Tracking Stripped", description=url, color = Color.random())
