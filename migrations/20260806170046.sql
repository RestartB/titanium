...
ALTER TABLE "bouncer_rules" ALTER COLUMN "rule_name" SET NOT NULL, ADD COLUMN "match_all_criteria" boolean NOT NULL DEFAULT true, ADD COLUMN "order" integer NOT NULL, ADD COLUMN "stop_if_triggered" boolean NOT NULL DEFAULT false;
