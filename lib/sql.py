...
class ServerLoggingSettings(Base):
    ...
    app_command_perm_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    dc_automod_rule_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    dc_automod_rule_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    dc_automod_rule_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    channel_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    channel_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    channel_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_name_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_afk_channel_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_afk_timeout_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_icon_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_emoji_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_emoji_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_sticker_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_sticker_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_invite_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    guild_invite_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_join_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_leave_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_nickname_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_roles_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_ban_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_unban_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_kick_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_timeout_id: Mapped[str] = MappedColumn(String, nullable=True)
    member_untimeout_id: Mapped[str] = MappedColumn(String, nullable=True)
    message_edit_id: Mapped[str] = MappedColumn(String, nullable=True)
    message_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    message_bulk_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    poll_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    poll_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    reaction_clear_id: Mapped[str] = MappedColumn(String, nullable=True)
    reaction_clear_emoji_id: Mapped[str] = MappedColumn(String, nullable=True)
    role_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    role_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    role_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    scheduled_event_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    scheduled_event_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    scheduled_event_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    soundboard_sound_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    soundboard_sound_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    soundboard_sound_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    stage_instance_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    stage_instance_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    stage_instance_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    thread_create_id: Mapped[str] = MappedColumn(String, nullable=True)
    thread_update_id: Mapped[str] = MappedColumn(String, nullable=True)
    thread_remove_id: Mapped[str] = MappedColumn(String, nullable=True)
    thread_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_join_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_leave_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_move_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_mute_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_unmute_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_deafen_id: Mapped[str] = MappedColumn(String, nullable=True)
    voice_undeafen_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_warn_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_mute_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_unmute_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_kick_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_ban_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_unban_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_case_delete_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_case_comment_id: Mapped[str] = MappedColumn(String, nullable=True)
    titanium_automod_trigger_id: Mapped[str] = MappedColumn(String, nullable=True)
