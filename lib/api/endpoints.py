        ...
        return web.json_response(
            {
                ...
                "ignored_roles": [],
                "ignored_channels": [],
                "bot_message_tracking": True,
                "bot_message_xp": False,
                "bot_vc_tracking": True,
                "bot_vc_xp": False,
    ...
    return web.json_response(
        {
            ...
            "bot_message_tracking": lb_settings.bot_message_tracking,
            "bot_message_xp": lb_settings.bot_message_xp,
            "bot_vc_tracking": lb_settings.bot_vc_tracking,
            "bot_vc_xp": lb_settings.bot_vc_xp,
